...
class Pembayaran extends Page
{
    ...
    private $snap_token = "1a69967a-0ce2-4119-97d6-a793183f8dff";
    protected function getViewData(): array
    {
        ...
        if ($formulir) {
            ...
            $response = Http::withHeaders([
                'spmb_token' => '1a69967a-0ce2-4119-97d6-a793183f8dff',
            ])->get($url_biaya);
            if ($response->status() == 200) {
                ...
                foreach ($billing['data'] as $item) {
                    ...
                    $response = Http::withHeaders(['spmb_token' => '1a69967a-0ce2-4119-97d6-a793183f8dff',])->get($url_status);
                }
                return [
                    "biaya" => $biaya,
                    "billing" => $billing,
